...
namespace RiderData
{
    public static class NewRider
    {
                ...
                if (SetRiderItem.Set_KartSN == Launcher.KartOld_SN)
                {
                    ...
                    if (Program.UseKartLevel)
                    {
                        if (SetRiderItem.Set_Kart <= 292 || SetRiderItem.Set_Kart == 358 || SetRiderItem.Set_Kart == 420 || SetRiderItem.Set_Kart == 464 || SetRiderItem.Set_Kart == 501 ||
                            ...
                            SetRiderItem.Set_Kart == 1238 || SetRiderItem.Set_Kart == 1265 || SetRiderItem.Set_Kart == 1268)
                        {
                            oPacket.WriteByte(0);
                        }
                        else
        ...
        {
            NewRider.Kart_X_Cut = 77;
            NewRider.Kart_Old_Cut = 313;
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= NewRider.MaxKart; i++)
                {
                    if (i <= 25 || i == 27 || i == 29 || i == 45 || i == 54 || i == 59 ||
                        ...
                        i == 1226 || i == 1229 || i == 1230 || i == 1234 || i == 1238 || i == 1239 || i == 1247 || i == 1251 || i == 1252 || i == 1261 || i == 1264 || i == 1265 || i == 1268 || //old
                        ...
                        i == 1259 || i == 1262) //X
                    {
                        ...
                        if (i <= 1095 || i == 1098 || i == 1103 || i == 1137 || i == 1193 || i == 1195 || i == 1199 || i == 1206 || i == 1208 || i == 1212 || i == 1215 || i == 1221 || i == 1222 || i == 1225 || i == 1226 ||
                            i == 1229 || i == 1230 || i == 1234 || i == 1238 || i == 1239 || i == 1247 || i == 1251 || i == 1252 || i == 1261 || i == 1264 || i == 1265 || i == 1268)
                        {
                            oPacket.WriteShort(Launcher.KartOld_SN);
                        }
                        else
        ...
        public static void Character()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int Character = 326;
                oPacket.WriteInt(Character - 31 - 35);
        ...
        public static void Aura()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                {
                    if (i == 28 || i == 33 || i == 35 || i == 53 || i == 54 || i == 58 || i == 59 || i == 76 || i == 78 || i == 89 || i == 97)
                    {
                    }
                    else
                    {
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= 1239; i++)
                {
                    if (i == 71 || i == 74 || i == 118 || i == 125 || i == 139 || i == 142 || i == 149 || i == 162 || i == 182 || i == 187 ||
                        ...
                        i == 1221 || i == 1222 || i == 1223 || i == 1224 || i == 1225 || i == 1226 || i == 1239 ||
        ...
        public static void MyRoom()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int MyRoom = 36;
                oPacket.WriteInt(MyRoom - 13);
                for (short i = 1; i <= MyRoom; i++)
                {
                    if (i == 1 || i == 4 || i == 5 || i == 10 || i == 11 || i == 12 || i == 13 || i == 14 || i == 15 || i == 16 || i == 22 || i == 27 || i == 28)
                    {
                    }
                    else
                    {
